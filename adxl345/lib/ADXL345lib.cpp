...
int Adafruit_ADXL345_Unified::readFrom(byte address, int num, byte _buff[]) {
...
void Adafruit_ADXL345_Unified::readXYZ(int *x, int *y, int *z) {
    readFrom(ADXL345_REG_DATAX0, 6, _buff); //read the acceleration data from the ADXL345
